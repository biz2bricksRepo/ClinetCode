...
import { parseFile } from "@/app/lib/actions";
...
import { saveContent } from "@/app/lib/actions";
    ...
    const handleSaveClick = async () => {
        if (parsedFileData && fileToParse) {
            ...
            if (saveResponse) {
                ...
                redirect('/dashboard/mydocuments');//window.location.href = '/dashboard/mydocuments';
            } else {
                        ...
                        {parsedFileData && (
                            <div>
                                ...
                                <div className={styles.wrapper}>
                                    ...
                                    <Link href="/dashboard/mydocuments">
