...
import { generateDocumentPrompts, getSearchResults, getFiles } from "@/app/lib/actions";
import FreeTextQA from "../FreeTextQA";
  ...
  return (
    <div className="flex flex-col md:flex-row gap-16 p-4 max-w-6xl mx-auto">
        ...
        <div className="mb-4 flex gap-2">
          ...
          {fileSuggestions.length > 0 && (
            <div className="absolute z-10 bg-white border rounded shadow mt-12 w-1/2">
              <div className="text-xs text-gray-500 mb-1 px-2 pt-2">File name suggestions:</div>
              <ul>
      ...
      <div className="md:w-1/3 w-full">
        <FreeTextQA sourceFile={fileName} />
      </div>
    </div>
  );
}
